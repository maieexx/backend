...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  //course info
  TextEditingController enrollingThissemTextEditingController = TextEditingController();
  TextEditingController enrolledLastsemTextEditingController = TextEditingController();
          ...
          child: Column(
            children: [
              ...
              SizedBox(
                ...
                height: 55,
                child: CustomTextFieldWidget(
                  editingController: enrollingThissemTextEditingController,
